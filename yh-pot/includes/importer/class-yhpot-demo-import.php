...
class Yhpot_Demo_Import {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_yhpot_import_demo_data', [ $this, 'import_demo_stage' ] );
	}
	...
	public function import_demo_stage() {
		...
		if ( current_user_can( 'manage_options' ) ) {
			...
			if ( ! class_exists( 'YHPOT_Importer_Data' ) ) {
				include_once YHPOT_INCLUDE_PATH . '/importer/class-yhpot-importer-data.php';
			}

			if ( ! class_exists( 'Yhpot_Demo_Content_Tracker' ) ) {
				include_once YHPOT_INCLUDE_PATH . '/importer/class-yhpot-demo-content-tracker.php';
			}

			$this->importer_files  = new YHPOT_Importer_Data( $this->demo_type );
			$this->content_tracker = new Yhpot_Demo_Content_Tracker( $this->demo_type );
	...
	private function before_import_stage() {
		...
		add_filter( 'intermediate_image_sizes_advanced', 'yhpot_filter_image_sizes' );
