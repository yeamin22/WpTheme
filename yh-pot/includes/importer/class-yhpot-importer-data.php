...
class YHPOT_Importer_Data {
	...
	public function __construct( $demo = null ) {
		...
		$this->basedir = wp_normalize_path( $upload_dir['basedir'] . '/yhpot-demo-data' );
	}
	...
	public static function get_data() {
        ...
        delete_transient("yhpot_demos");
		$demos = get_transient( 'yhpot_demos' );
		...
		if ( false === $demos ) {
			...
			$demos = file_get_contents( get_template_directory() . '/includes/importer/demo.json' );
	...
	/* 		$args         = [
			...
			set_transient( 'yhpot_demos', $demos, WEEK_IN_SECONDS );
		}
		return $demos;
	}
